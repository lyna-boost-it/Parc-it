...
{ public function __construct()
 ...
 AllSticker_Checker( );
       return redirect()->route ('ParkManager.stickers.index')->with('success',"vous avez ajouter une vignette avec succès");
    }
 ...
 return view("ParkManager.stickers.edit", compact('sticker') );
    ...
    public function update(Request $request, $id)
    {
        ...
        $sticker->update($request->only(
            ...
            AllSticker_Checker( );
                ...
                return redirect('/ParkManager/stickers')->with('success',"vous avez renouveler une vignette avec succès");
    }
    ...
    public function destroy($id)
    {
        ...
        $sticker->delete();
        return redirect('/ParkManager/stickers')->with('success',"vous avez supprimer une vignette avec succès");
    }
}
