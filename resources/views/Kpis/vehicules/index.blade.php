...
<body>
    ...
    <div class="main-container">
        ...
        <div id="test">
            ...
            <div class="xs-pd-20-10 pd-ltr-20">
                <div class="card-box pd-20 height-100-p mb-30">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <img src="{{ URL('assets/vendors/images/vehicules.png') }}"; alt="" />
                        </div>
                        <div class="col-md-8">
                            ...
                            <p class="font-18 max-width-600">
                                vous trouverez ici les détails et les statistiques sur les véhicules et leur
                                utilisation.
                                <b>Le {{ $date }}</b>
                            </p>
                        </div>
            ...
            <div class="xs-pd-20-10 pd-ltr-20">
                <div class="card-box pd-20 height-100-p mb-30">
                    <div class="row align-items-center">
                        <div class="weight-600 font-30 text-grey">L'état des Véhicules :

                        </div>
                        <div class="col-md-8">
                            <form action="{{ route('Kpis.vehicules.create') }}" method="get">
                                @csrf
            ...
            <div class="col-md-6 mb-20">
                <div class="card-box height-100-p pd-20">
                    <h4 class="weight-600 font-20 text-orange">
                        Nombre totale des Véhicules {{ $vehiculesNumber }}.
    ...
    <input type="hidden" value="{{ $minibusesNumber }} " id="minibusesNumber">
    <input type="hidden" value="{{ $pickupsNumber }} " id="pickupsNumber">
    <input type="hidden" value="{{ $foursNumber }} " id="foursNumber">
...
<script>
    var minibusesNumber = parseInt($("#minibusesNumber").val());
    var pickupsNumber = parseInt($("#pickupsNumber").val());
    var foursNumber = parseInt($("#foursNumber").val());
    ...
    let chartConfig = {
        ...
        series: [{
                text: 'Minibus ',
                values: [minibusesNumber],
                backgroundColor: '#FA9494',
            },
            {
                text: 'Pick-up ',
                values: [pickupsNumber],
                backgroundColor: '#5F6F94',
            },
            {
                text: 'Mini-fourgonnettes',
                values: [foursNumber],
