                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <h4 class="font-20 weight-500 mb-10 text-capitalize">
                                ...
                                <div class="weight-600 font-30 text-orange">L'état des engins et matériels agricoles dans le Mois de <b>
                                        @switch($month)
                                            @case(1)
                                                Janvier
                                            @break
                            ...
                            <div class="rounded-lg bg-white shadow-lg md:shadow-xl relative overflow-hidden">
                                <div class="px-3 pt-12 pb-10 text-center relative z-20">
                                    <h1 class="text-sm uppercase text-gray-500 leading-tight text-orange  "
                                        style="font-size: 2.5em;">Nombre totale des pannes</h1>
                            ...
                            <div class="rounded-lg bg-white shadow-lg md:shadow-xl relative overflow-hidden">
                                <div class="px-3 pt-12 pb-10 text-center relative z-20">
                                    <h1 class="text-sm uppercase text-gray-500 leading-tight  "
                                        style="font-size: 2.5em;">Pannes Lourde</h1>
                                    <h3 class="text-3xl text-gray-700 font-semibold leading-tight my-3 text-orange">
                                        {{ $lourde }} Pannes</h3>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <h4 class="font-20 weight-500 mb-10 text-capitalize">
                                ...
                                <div class="weight-600 font-30 text-orange">Taux des DT ( Demandes de Travaux) traitées le Mois de <b>
                                        @switch($monthDT)
                                            @case(1)
                                                Janvier
                                            @break
