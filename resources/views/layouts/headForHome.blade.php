...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL('assets/src/plugins/jquery-steps/jquery.steps.css') }}"; />
    <link rel="stylesheet" type="text/css"
    ...
    <script src="{{ URL('assets/vendors/scripts/dashboard3.js') }}" ;>
        < /script <
        script src = "{{ URL('assets/src/plugins/datatables/js/jquery.dataTables.min.js') }}"; >
    </script>
