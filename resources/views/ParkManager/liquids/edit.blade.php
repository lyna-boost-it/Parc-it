...
<html>
    ...
    <form action="{{route('ParkManager.liquids.update',$liquid->id)}}" method="post">

        @csrf      {{method_field('PUT')}}
    <div class="card">

        <div class="card-header">
            <h3 class="title">Ajoute  {{ $liquid->type }}</h3>
        </div>
        ...
        <input type='hidden' id='price' name="price" value={{  $liquid->price }}
        >
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn   btn-round" style="background:#EE643A;color:#ffffff;">{{ __('Ok') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
