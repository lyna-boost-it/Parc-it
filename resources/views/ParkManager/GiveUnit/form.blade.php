                ...
                <div class="page-header">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h3 style="color:#EE643A; ">Effectuez une unité ?</h3>
                            </div>
                        ...
                        <div class="card-box height-100-p pd-20">
                            ...
                            <form action="{{ route('ParkManager.GiveUnit.update', $id) }}" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button type="submit" class="btn   btn-round"
                                                    style="background:#EE643A;color:#ffffff;">{{ __('Transférer') }}</button>
                                            </div>
                                        </div>
