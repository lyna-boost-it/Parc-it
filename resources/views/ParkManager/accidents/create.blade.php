        ...
        <div class="main-container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <form action="{{ route('ParkManager.accidents.store', $accident->id) }}" method="post"
                                                ...
                                                <select name="driver_id" placeholder="  Nom et prénom de l\'absent"
                                                    ...
                                                    @foreach ($drivers as $driver)
                                                        <option value="{{ $driver->id }}"
                                                            {{ old('driver_id', $accident->driver_id) === 'driver_id' ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            "
                                                    ...
                                                    <h1>Type: {{ $vehicule->vehicle_type }}, Marque:
                                                        {{ $vehicule->mark }}</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn   btn-round"
                                            style="background:#EE643A;color:#ffffff;">{{ __('Declarer') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
