...
<html>
	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.dtsM.store',$dt->id)}}" method="post" enctype="multipart/form-data">
    ...
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" >
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('  Nom et prénom d\'Employé') }}</label>
                                <div class="col-md-9" for="conducteur_field_for_absence">
                                    <div class="form-group">
                                        <select  name="emp_id"   placeholder="  Nom et prénom de l\'absent"
                                        value="{{ old('emp_id'),$dt->emp_id }}"class="form-control"
                                            id="staff_type">
                                            @foreach ($staffs as $staff)

                                            <option value="{{ $staff->id }}"
                                            {{ old('emp_id', $dt->emp_id)
                                             === 'emp_id' ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9" for="Territoire">
                                        <div class="form-group">
                                            ...
                                            <select  name="mm_id"   placeholder="  MATÉRIELS MOTORISÉS "id="mm_id"
                                          class="form-control"
                                               >
