                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h4 style="display: inline; color:#000000">Employé: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $emp->name }}
                                                {{ $emp->last_name }}</h5>
                                        </th>
                                    ...
                                    <tr>
                                        <th> <h4 style="display: inline;color:#000000 ">Type de machine: </h4>
                                    ...
                                    <tr>
                                        <th>  <h4 style="display: inline;color:#000000">Année mise en service: </h4>
                                            <h5 style="display: inline;color:#000000">
                                                {{ $material->year_commissioned }}</h5>
                                        </th>
                                    ...
                                    <tr><th>  <h4 style="display: inline; color:#000000">Type de maintenance: </h4>
                                        <h5 style="display: inline;color:#000000">
