                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('ParkManager.dtsM.edit', $maintenance->id) }}"
                                                            ...
                                                            <a class="dropdown-item "
                                                                href="{{ route('ParkManager.dtsM.show', $maintenance->id) }}"><i
                                                                    class="dw dw-eye"></i> Consulter</a>
                                                            @if (Auth::user()->type == 'Gestionnaire Sup')
                                                                <a class="dropdown-item "
                                                                    href="{{ route('ParkManager.dtsM.show', $maintenance->id) }}"
                                                            ...
                                                            @else
                                                                <form class="form-delete dropdown-item" method="post"
                                                                    action="{{ route('ParkManager.dtsM.destroy', $maintenance->id) }}">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="submit"
