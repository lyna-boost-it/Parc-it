                    ...
                    <div id="test">
                        <div class="page-header">
                            ...
                            <div class="row">
                                 ...
                                 <h6>Pour: {{ $driver->name }} {{ $driver->last_name }}, Fonction: {{ $driver->function }}</h6>
                        ...
                        <div class="page-header">
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color:#000000"> Numéro d'amande: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $amande->id }}</h5>
                                        </th>


                                        <th>
                                            <h4 style="display: inline;color:#000000">Date d'infraction (amande): </h4>
                                            <h5 style="display: inline;color:#000000">{{ $amande->p_name }} </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color:#000000">Infraction: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $amande->infraction }}</h5>
                                        </th>
                                        <th>
                                    ...
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color:#000000">Sanction: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $amande->sanction }}</h5>

                                        <th>
                                            <h4 style="display: inline;color:#000000">Période de la sanction:</h4>
                                            <h5 style="display: inline;color:#000000">{{ $amande->period }}
                                            </h5>
                                    </tr>
