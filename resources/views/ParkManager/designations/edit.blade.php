	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.designations.update',$designation->id)}}" method="post">
    ...
    @csrf      {{method_field('PUT')}}
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="title">{{ __('Modifier une designaton') }}</h5>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Designaton') }}<span class="ob">*</span></label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Designaton" value="{{ $designation->name }}" required>
                                    </div>
