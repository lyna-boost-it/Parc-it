                    ...
                    <div id="test">
                        <div class="page-header">
                            <div class="row">
                                ...
                                <h3>Information de maintenance externe pour {{ $dt->code_dt }}: </h3>
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <h4  style="display: inline;color: #000000 ">matériel motorisé: </h4>
                                            <h5  style="display: inline;color: #000000">{{ $material->type_of_machine }} </h5>
                                        </th>
                                    </tr>
