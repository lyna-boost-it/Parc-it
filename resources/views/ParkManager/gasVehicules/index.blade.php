                                    ...
                                    @foreach ($drivers as $driver)
                                        @foreach ($vehicules as $vehicule)
                                            @foreach ($staffs as $staff)
                                                @if ($gasvehicule->driver_id == $driver->id &&
                                                    $gasvehicule->vehicle_id == $vehicule->id &&
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ParkManager.gasVehicules.edit', $gasvehicule->id) }}"@if (Auth::user()->type == 'Gestionnaire Sup')     style="  color: currentColor;
                                                                        cursor: not-allowed;
                                                                        opacity: 0.5;
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('ParkManager.gasVehicules.show', $gasvehicule->id) }}"><i
                                                                          ...
                                                                          method="post"
                                                                          action="{{ route('ParkManager.gasVehicules.destroy', $gasvehicule->id) }}">
                                                                          @method('DELETE')
                                                                          @csrf
                                                                          <button type="submit"
