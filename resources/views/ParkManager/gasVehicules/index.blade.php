				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Gestion des  consommations de carburant pour véhicule</h4>
                     		</div>
                        ...
                        " href="{{route('ParkManager.gasVehicules.create')}}" class="btn btn-sm btn-success">
								...
								<tbody>
                                    @foreach($gasvehicules as $gasvehicule)
                                          @foreach($drivers as $driver)
                                            ...
                                            @if ($gasvehicule->driver_id==$driver->id && $gasvehicule->vehicle_id==$vehicule->id
                                                 ...
                                                 <td  >
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.gasVehicules.edit',$gasvehicule->id)}}"
                                                                ><i class="dw dw-edit2"></i> Modifier</a>

    <a class="dropdown-item" href="{{route('ParkManager.gasVehicules.show',$gasvehicule->id)}}"
                                                                ><i class="dw dw-eye"></i> Consulter</a>


                                                            <form class="form-delete dropdown-item" method="post" action="{{route('ParkManager.gasVehicules.destroy',$gasvehicule->id)}}">
                                                                @method('DELETE')
                                                                @csrf
