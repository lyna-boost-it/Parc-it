			...
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div id="test">
                    <div class="page-header">
                        <div class="row">
                                <div class="title">
                                    <h4>Information de Consommation: </h4>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart" style="display: inline;">
                                                        ...
                                                        <h5  style="display: inline;">{{ $gasvehicules->date }}</h5>
                                                        <br>
                                                        <h4 style="display: inline;" >Nom et prénom du conducteur: </h4>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                        ...
                                                        <br>
                                                        <h4  style="display: inline; ">Agent remplisseur: </h4>
                                                        <h5 style="display: inline;">{{ $staff->p_name }} {{ $staff->p_last_name }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                    ...
                                                    <h5 style="display: inline;">{{ $gasvehicules->km }}</h5>
                                                    <br>
                                                    <h4  style="display: inline;" >Type:</h4>
                                                    <h5 style="display: inline;">{{ $gasvehicules->type }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6  ">
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                    <h4 style="display: inline;" >Coût: </h4>
                                                    <h5 style="display: inline;"> {{ $gasvehicules->price }}</h5>
                                                    <br>
                                                    <h4  style="display: inline;">Litre de Carburant (facultatif): </h4>
                                                    <h5 style="display: inline;"> {{ $gasvehicules->litter }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                    <h4  style="display: inline;" >Prix du litre:</h4>
                                                    <h5 style="display: inline;"> {{ $gasvehicules->litter_price }}</h5>
                                                    <br>
                                                    <h4  style="display: inline;" >N du ticket:</h4>
                                                    <h5 style="display: inline;">{{ $gasvehicules->ticket }}</h5>
                                                </div>
                                            </div>
                                        </div>
