                ...
                <div class="xs-pd-20-10 pd-ltr-20">
                    ...
                    <div id="test">
                        <div class="page-header">
                            ...
                            <form  action="{{ route('gas-pdf',$gasvehicules->id) }}" method="post" target="__blank">
                                @csrf
                       ...
                       <div class="page-header" >
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    <tr>
                                        <th>
                                            <h4  style="display: inline;color:#000000">Date: </h4>
                                            <h5  style="display: inline;color:#000000">{{ $gasvehicules->date }}</h5>
                                            <br>
                                        ...
                                        <th>
                                            ...
                                            <br>
                                            <h4  style="display: inline; color:#000000">Agent remplisseur: </h4>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;color:#000000"> {{ $gasvehicules->price }}</h5>
                                            <br>
                                            <h4  style="display: inline;color:#000000">Litre de Carburant (facultatif): </h4>
                                            <h5 style="display: inline;color:#000000"> {{ $gasvehicules->litter }}</h5>

                                        <th>
                                            <h4  style="display: inline;color:#000000" >Prix du litre:</h4>
                                            <h5 style="display: inline;color:#000000"> {{ $gasvehicules->litter_price }}</h5>
                                            <br>
                                            <h4  style="display: inline;color:#000000" >N du ticket:</h4>
                                            <h5 style="display: inline;color:#000000">{{ $gasvehicules->ticket }}</h5>
                                    </tr>
