	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.maintenances.storeMaintenance',$maintenance->id)}}" method="post">
    ...
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="title">{{ __('Créer un entretien ') }}</h3>
                        </div>
                    ...
                    <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9" >
                                    <div class="form-group">
                                        ...
                                        value="{{ $maintenance->designation }}" required>
                                    </div>
                        ...
                        <div class="card-body" >
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Liquide consommés (littre)') }} Max {{ $liquid->quantity }}</label>
                                <div class="col-md-9" >
                                    <div class="form-group">
                                        <input type="number"
                                         name="liquid"
                                         max={{ $liquid->quantity }}
                                         class="form-control"
                                         placeholder="Liquide consommés (littre)"
                                          value="{{ $maintenance->liquid}}" required>
                                    </div>
                        ...
                        <div class="card-body" >
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Lubrifiant consommés (littre)') }}  Max {{ $lubrifiant->quantity }}</label>
                                <div class="col-md-9" >
                                    <div class="form-group">
                                        <input type="number"
                                         name="lubricant"
                                         max={{ $lubrifiant->quantity }}
                                         class="form-control"
                                         placeholder="Lubrifiant consommés (littre)"
                                          value="{{ $maintenance->lubricant}}" required>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9" for="conducteur_field_for_absence">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('driver_id'),$maintenance->driver_id }}"class="form-control"
                                            id="staff_type">
                                            @foreach ($drivers as $driver)

                                            <option value="{{ $driver->id }}"
                                            {{ old('driver_id', $maintenance->driver_id)
                                             === 'driver_id' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" name="action" value="end"
                                        class="btn   btn-round" style="background:#EE643A;color:#ffffff;">{{ __('Enregistrer') }}</button>
                                </div>
                            </div>
                        </div>
        </div>
