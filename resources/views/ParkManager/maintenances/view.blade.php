			...
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div id="test">
                    <div class="page-header">
                        <div class="row">
                                <div class="title">
                                    <h4>Information d'entretien pour {{ $dt->code_dt }}:</h4>
                                </div>
                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-chart"  >
                                        ...
                                        <h5  style="display: inline;">{{ $maintenance->designation }} </h5>
                                        <br>
                                        <h4 style="display: inline;" >KM: </h4>
                                        <h5 style="display: inline;">{{ $maintenance->km }} </h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-desk">
                                        ...
                                        <h5 style="display: inline;">@foreach ($maintenance_staffs as $maintenance_staff)
                                            @foreach ($staffs as $staff)
                                            @if($maintenance_staff->staff_id==$staff->id && $maintenance_staff->maintenance_id=$maintenance->id)
                                        ...
                                        @endforeach </h5>
                                        <br>
                                        <h4 style="display: inline;" >Liquide consommés: </h4>
                                        <h5 style="display: inline;">{{  $maintenance->liquid }} </h5>
                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-chart"  >
                                        ...
                                        <h5  style="display: inline;">{{  $maintenance->lubricant}} </h5>
                                        <br>
