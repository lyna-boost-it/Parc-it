                        ...
                        <div class="page-header" style="background-color:#aa4b2e">
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    <tr>
                                        <th>
                                            <h4  style="display: inline; color:#000000">N° de la demande de travaux (DT) : </h4>
                                            <h5  style="display: inline;color:#000000">{{ $maintenance->code_dt }}</h5><br>
                                            <h4 style="display: inline;color:#000000" >Date et Heure: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $maintenance->created_at}}</h5>
                                        </th>


                                        <th>
                                            <h4   style="display: inline;color:#000000">TYPE DE PANNE: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $maintenance->type_panne }}</h5>
                                            <br>
                                            <h4 style="display: inline;color:#000000" >Nature de Panne: </h4>
                                            <h5 style="display: inline;color:#000000">{{ $maintenance->nature_panne }}</h5>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <th>
                                            ...
                                            <h5 style="display: inline;color:#000000">{{ $staff->name }} {{ $staff->last_name }}</h5>
                                            <br>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h4  style="display: inline;color:#000000 ">DATE ET HEURE D’ENTREE(État): </h4>
                                            <h5  style="display: inline;color:#000000">{{ $maintenance->enter_date }} {{ $maintenance->enter_time }}</h5>
                                            <br>
                                        ...
                                        <th>
                                            ...
                                            <h5 style="display: inline;color:#000000">{{ $maintenance->observation }}</h5>
                                    </div>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>
                                            ...
                                            <h5  style="display: inline;color:#000000">{{ $maintenance->type_maintenance}}</h5>
                                        </th>
