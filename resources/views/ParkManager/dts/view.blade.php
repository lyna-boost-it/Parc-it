                                    ...
                                    <div class="col-md-6  ">
                                        <div class="panel">
                                            <div class="panel-body bio-desk">
                                                <h4 style="display: inline;color:#000000">Personne(s) intervenante(s): </h4>
                                                <h5 style="display: inline;color:#000000">
                            ...
                            <div class="page-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6  ">
                                        <div class="panel">
                                            <div class="panel-body bio-chart">
                                                ...
                                                <h5 style="display: inline;color:#000000">{{ $repair->intervention_date }}</h5>
                                                <br>
                                                <h4 style="display: inline;color:#000000"> Diagnostique: </h4>
                                                <h5 style="display: inline;color:#000000">{{ $repair->diagnostic }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6  ">
                                        <div class="panel">
                                            <div class="panel-body bio-desk">
                                                ...
                                                <h5 style="display: inline;color:#000000">{{ $repair->repaired_breakdowns }}</h5>
                                    ...
                                    <div class="col-md-6  ">
                                        <div class="panel">
                                            <div class="panel-body bio-desk">
                                                <h4 style="display: inline;color:#000000">Date et Heure de sortie: </h4>
                                    ...
                                    <div class="col-md-6  ">
                                        <div class="panel">
                                            <div class="panel-body bio-desk">
                                                <h4 style="display: inline;color:#000000">Observation: </h4>
                                                <h5 style="display: inline;color:#000000">{{ $repair->observation }}</h5>
                                                <br>
                                                <h4 style="display: inline;color:#000000">Conducteur (sortie): </h4>
                                                <h5 style="display: inline;color:#000000">{{ $driver->name }}
                                                    {{ $driver->last_name }}
                            ...
                            @foreach ($designations as $designation)
                                ...
                                @if ($rp->type == $designation->id && $rp->marque == $mark->id)
                                    <div class="sidenav">
                                        ...
                                        <button
                                            class="dropdown-btn">Marque: {{ $mark->name }}</b> Type: {{ $designation->name }}
