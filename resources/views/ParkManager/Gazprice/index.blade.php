                        ...
                        <div class="col-md-7 col-sm-12">
                            <div class="title">
                                <h4 style="color:#EE643A; ">
                                    Gestion des prix carburants </h4>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="dropdown-item"
                                                                href="{{ route('ParkManager.Gazprice.edit', $gase->id) }}"@if (Auth::user()->type == 'Gestionnaire Sup')     style="  color: currentColor;
                                                                cursor: not-allowed;
                                                                opacity: 0.5;
                                                                text-decoration: none;"  @endif ><i
                                                                    class="dw dw-edit2" ></i> Modifier Prix</a> </td>
