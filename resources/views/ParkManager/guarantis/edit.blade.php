...
<html>
    ...
    <form action="{{route('ParkManager.guarantis.update',$guaranti->id)}}" method="post">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="title">{{ __('Modifier un  service après-vente et Garantis  ') }}</h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9" >
                    <div class="form-group">
                        ...
                        placeholder=" Réf du fournisseur "
            ...
            <div class="row">
                ...
                <div class="col-md-9" >
                    <div class="form-group">
                        ...
                        value="{{ $guaranti->after_sold_service }}" required>
                    </div>
                    @if ($errors->has('after_sold_service'))
                        <span class="invalid-feedback" style="display: block;" role="alert">
                            <strong>{{ $errors->first('after_sold_service') }}</strong>
                        </span>
                    @endif
                </div>
            </div>
