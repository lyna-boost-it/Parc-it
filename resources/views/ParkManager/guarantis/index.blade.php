                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.guarantis.edit',$guaranti->id)}}"
                                                                ><i class="dw dw-edit2"></i> Modifier</a>
                    <a class="dropdown-item" href="{{route('ParkManager.guarantis.show',$guaranti->id)}}"
                                                                ><i class="dw dw-edit2"></i> Consulter</a>

                                                            <form class="form-delete dropdown-item" method="post" action="{{route('ParkManager.guarantis.destroy',$guaranti->id)}}">
                                                                @method('DELETE')
                                                                @csrf
