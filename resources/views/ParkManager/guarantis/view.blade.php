                        ...
                        <div class="page-header" style="background-color:#aa4b2e">
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <th>
                                            <h4   style="display: inline;color: #000000">Durée de la Garantie(par Km ou par Année): </h4>
                                        ...
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000">{{ $garantie->garanti_type }}</h5>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000"><b> Nom fournisseur:</b> {{ $garantie->name_vendor }}
                                               </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000">{{ $garantie->address_vendor }}</h5>

                                        </th><th>
                                            <h4   style="display: inline;color: #000000">Service Après-Vente: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $garantie->after_sold_service }}  </h5>
