                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.insurances.edit',$insurance->id)}}"
                                                                ...
                                                                <a class="dropdown-item" href="{{route('ParkManager.insurances.show',$insurance->id)}}"
                                                                  ...
                                                                  @else
                                                                  <form class="form-delete dropdown-item" method="post" action="{{route('ParkManager.insurances.destroy',$insurance->id)}}">
                                                                    @method('DELETE')
                                                                    @csrf
