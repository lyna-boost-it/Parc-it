...
<html>
	...
	<body>
				...
				<div class="page-header">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h3 style="color:#EE643A; ">Gestion des  matériels motorisés</h3>
                     		</div>
      ...
      text-decoration: none;  @endif
                            " href="{{route('ParkManager.materialsmanager.create')}}" class="btn btn-sm  ">
                                Créer un  matériel motorisé
                            </a>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.materialsmanager.edit',$material->id)}}"
                                                                @if (Auth::user()->type == 'Gestionnaire Sup') style="  color: currentColor;
                                                                cursor: not-allowed;
                                                                opacity: 0.5;
                                                                text-decoration: none;" @endif  ><i class="dw dw-edit2"></i> Modifier</a>
                                                               <a class="dropdown-item" href="{{route('ParkManager.materialsmanager.show',$material->id)}}"
                                                              ...
                                                              @else
 <form class="form-delete dropdown-item" method="post" action="{{route('ParkManager.materialsmanager.destroy',$material->id)}}">
                                                                @method('DELETE')
                                                                @csrf
