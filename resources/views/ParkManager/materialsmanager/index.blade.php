                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('ParkManager.materialsmanager.edit', $material->id) }}"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('ParkManager.materialsmanager.show', $material->id) }}"><i
                                                    ...
                                                    @else
                                                        <form class="form-delete dropdown-item" method="post"
                                                            action="{{ route('ParkManager.materialsmanager.destroy', $material->id) }}">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button type="submit"
