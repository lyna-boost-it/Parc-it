                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-chart"  >
                                        <h4  style="display: inline; "> Réf d'achat: </h4>
                                        <h5  style="display: inline;">{{ $material->ref }} </h5>
                                        <br>
                                        <h4 style="display: inline;" >Code d'investissement: </h4>
                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-desk">
                                        ...
                                        <br>
                                        <h4 style="display: inline;" >Marque: </h4>
                                        <h5 style="display: inline;">{{  $material->mark }} </h5>
                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-chart"  >
                                        ...
                                        <br>
                                        <h4 style="display: inline;" >Unité: </h4>
                        ...
                        <div class="col-md-6  ">
                            <div class="panel">
                                <div class="panel-body bio-desk">
                                        ...
                                        <br>
                                        <h4 style="display: inline;" > Date d'affectation: </h4>
                                        <h5 style="display: inline;">{{ $material->affectation_date }} </h5>
