	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.materialsmanager.store',$material->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                placeholder="Réf d’achat" value="{{ $material->ref }}" required>
                            </div>
                            @if ($errors->has('ref'))
                        ...
                        <label class="col-md-3 col-form-label">{{ __(' Code d’investissement') }}</label>
                                                <div class="col-md-9" >
                                                    <div class="form-group">
                                                        ...
                                                        placeholder=" Code d’investissement"
                        ...
                        <label class="col-md-3 col-form-label">{{ __(' Type de la machine') }}</label>
                                                <div class="col-md-9" >
                                                    ...
                                                    @if ($errors->has('type_of_machine'))
                                                        <span class="invalid-feedback" style="display: block;" role="alert">
                                                            <strong>{{ $errors->first('type_of_machine') }}</strong>
                                                        </span>
                                                    @endif
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            ...
                            value="{{ $material->affectation_date }}" required>
                        </div>
                        @if ($errors->has('affectation_date'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $errors->first('affectation_date') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
            ...
            <div class="card-body" >
                <div class="row">
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            <select id="unit_id" type="text" class="form-control select2 @error('unit_id') is-invalid
                            @enderror" name="unit_id" required autocomplete="battery_type" autofocus>
