	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <form action="{{route('ParkManager.staffs.update',$staff->id)}}" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="title">{{ __('Modifier un personnel ') }}</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="address" name="address" class="form-control"
                                                    placeholder=" Adresse" value="{{ $staff->address }}" required>
                                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="date" id="date_of_recruitment" name="date_of_recruitment"
                                                class="form-control" placeholder=" Date de date_of_recruitment "
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="phone" name="phone" class="form-control" maxlength="10"
                                                minlength="10" placeholder="N° du Téléphone"
