                ...
                <div class="col-md-12 text-center">
                    <form action="{{ route('ParkManager.staffs.store', $staff->id) }}" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <label class="col-md-3 col-form-label">{{ __('Type Personnel') }}<span class="ob">*</span></label>
                                    <div class="col-md-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label
                                                class="col-md-3 col-form-label">{{ __('Lieu de naissance') }}<span class="ob">*</span></label>
                                            <div class="col-md-9">
                                                <div class="form-group">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <label
                                            class="col-md-3 col-form-label">{{ __(' Date de recrutement ') }}<span class="ob">*</span></label>
                                        <div class="col-md-9">
                                            <div class="form-group">
