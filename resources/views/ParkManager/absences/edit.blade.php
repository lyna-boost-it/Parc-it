...
<html>
    ...
    <form action="{{route('ParkManager.absences.update',$absence->id)}}" method="post">
    ...
    <div class="card">
        ...
        <br><br><br>
                                ...
                                <div class="card-header">
                                    <h3 class="title">{{ __('Modifier une Absence ') }}</h3>
                                    <h4 class="title">{{ __('Pour: ') }}{{ $staff->name }} {{ $staff->last_name }}</h4>
                                </div>
