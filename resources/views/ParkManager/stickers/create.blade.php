        ...
        <div class="main-container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <form action="{{ route('ParkManager.stickers.store', $sticker->id) }}" method="post">
                        ...
                        <div class="card">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="number" min="1900" max="2099" step="1"
                                                name="year" class="form-control" placeholder=" Année (en cours) "
                                                value="{{ $sticker->year }}" required>
                                        </div>
                                        @if ($errors->has('year'))
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <select name="vehicule_type" class="form-control" id="vehicule_type">
                                                <option value="" disabled selected>Choisissez un type de véhicule
                                                </option>
                            ...
                            <div id="mini-fourgonnettes_Div">
                                <div class="card-body">
                                    <div class="row">
                                        <label
                                            class="col-md-3 col-form-label">{{ __('  Vehicules de type mini-fourgonnettes') }}</label>
                                        <div class="col-md-9" for="Territoire">
                                            <div class="form-group">

                                                <select name="vehicule1" placeholder="  Vehicule" id="fourgonnettes"
                                                    id="v1" class="form-control">
                            ...
                            <div id="minibus_Div">
                                <div class="card-body">
                                    <div class="row">
                                        <label
                                            class="col-md-3 col-form-label">{{ __('  Vehicules de type Minibus') }}</label>
                                        <div class="col-md-9" for="minibus_Div">
                                            <div class="form-group">

                                                <select name="vehicule2" placeholder="  Vehicule" id="v2"
                                                    class="form-control" id="minibus">
                            ...
                            <div id="pick-up_Div">
                                <div class="card-body">
                                    <div class="row">
                                        <label
                                            class="col-md-3 col-form-label">{{ __('  Vehicules de type Pick-up') }}</label>
                                        <div class="col-md-9" <div class="form-group">

                                            <select name="vehicule3" placeholder="  Vehicule" id="pick-up"
                                                id="v3" class="form-control" id="pick-up">
