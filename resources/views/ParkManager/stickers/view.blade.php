                ...
                <div id="test">
                    <div class="page-header">
                        <div class="row">
                            ...
                            <h3>Information de Vignettes: </h3>
                            ...
                            <table style=" width: 90%;border-collapse: collapse;">
                                <tr>
                                    <th>
                                        ...
                                        <h5  style="display: inline;color:#000000">{{ $sticker->id }}</h5></th>


                                    <th>
                                        <h4 style="display: inline;color:#000000" > Année (en cours): </h4>
                                        <h5 style="display: inline;color:#000000">{{ $sticker->year }}</h5></tr>
                                <tr>
                                    <th>
                                        <h4   style="display: inline;color:#000000">Validité: </h4>
                                        <h5 style="display: inline;color:#000000">{{ $sticker->validity }}</h5></th>
                                    <th>
