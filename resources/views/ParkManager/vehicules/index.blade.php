                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.vehicules.edit',$vehicule->id)}}"
                                                                @if (Auth::user()->type == 'Gestionnaire Sup') style="  color: currentColor;
                                                                cursor: not-allowed;
                                                                opacity: 0.5;
                                                                text-decoration: none;" @endif ><i class="dw dw-edit2"></i> Modifier</a>
                                                                <a class="dropdown-item" href="{{route('ParkManager.vehicules.show',$vehicule->id)}}"
                                                              ...
                                                              <form class="form-delete" method="post" action="{{route('ParkManager.vehicules.destroy',$vehicule->id)}}">
                                                                @method('DELETE')
                                                                @csrf
