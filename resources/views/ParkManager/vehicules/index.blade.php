@if (Auth::user()->type == 'Gestionnaire parc' ||
                ...
                <div class="page-header">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h3 style="color:#EE643A; "> Gestion des Véhicules</h3>
                            </div>
  ...
  text-decoration: none; @endif
                        "
                            href="{{ route('ParkManager.vehicules.create') }}" class="btn btn-sm ">
                            Créer un véhicules
                        </a>
                    </div>
                    <div class="pb-20">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('ParkManager.vehicules.edit', $vehicule->id) }}"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('ParkManager.vehicules.show', $vehicule->id) }}"><i
                                                            ...
                                                            @else
                                                                <form class="form-delete" method="post"
                                                                    action="{{ route('ParkManager.vehicules.destroy', $vehicule->id) }}">
                                                                    @method('DELETE')
                                                                    @csrf
