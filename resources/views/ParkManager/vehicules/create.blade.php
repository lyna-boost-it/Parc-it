...
<html>
	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.vehicules.store',$vehicule->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card">
            ...
            <div class="card-body" >
                <div class="row">
                    <label class="col-md-3 col-form-label">{{ __('Information de la carte grise') }}</label>
