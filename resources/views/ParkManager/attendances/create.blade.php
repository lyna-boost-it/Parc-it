    ...
    <div class="main-container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <form action="{{ route('ParkManager.attendances.storeAttendance', $staff->id) }}" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="title">Le {{ $ldate }}: Marquer la présence pour: </h4>
                        </div>
                        <h5 class="title"> {{ $staff->name }} {{ $staff->last_name }} </h5>
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" id="arrived_at_date" name="arrived_at_date"
                                value="{{ $ldate }}">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="time" id="arrived_at_time" name="arrived_at_time"
                                                class="form-control" placeholder="Heure d’Entrée"
                                                required>
                                        </div>
                                        @if ($errors->has('date_of_birth'))
                                            <span class="invalid-feedback" style="display: block;" role="alert">
                                                <strong>{{ $errors->first('arrived_at_time') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <select id="day_type" type="text"
                                                class="form-control select2 @error('day_type') is-invalid @enderror"
                                                name="day_type" required autocomplete="day_type" autofocus>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="work_place" name="work_place" class="form-control"
                                                placeholder="Lieu des travaux" value="{{ $attendance->work_place }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="work_type" name="work_type" class="form-control"
                                                placeholder="Nature des travaux" value="{{ $attendance->work_type }}"
                                                required>
                                        </div>
