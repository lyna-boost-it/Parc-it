    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                    <form action="{{route('ParkManager.attendances.update',$unit->id)}}" method="post">
...
<div class="card">
    ...
    <br>
                            ...
                            <div class="card-header">
                                <h5 class="title">         Marquer la Sortie  </div>
                            <div class="card-body">
        ...
        <div class="card-body">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <select  name="staff_id"
                         value="{{ old('staff_id'),$attendance->staff_id }}"class="form-control"
                            id="staff_id">
                            <option value="
                            {{ $staff->id }}">{{ $staff->name  }} {{ $staff->last_name }}</option>
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            ...
                            name="left_at_time"
                             ...
                             value="{{ $attendance->left_at_time }}" required>
                        </div>
                        @if ($errors->has('date_of_birth'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $errors->first('left_at_time') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            ...
                            name="left_at_date"
                             ...
                             value="{{ $attendance->left_at_date }}" required>
                        </div>
                        @if ($errors->has('date_of_birth'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $errors->first('left_at_date') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            ...
                            name="observation"
                             ...
                             value="{{ $attendance->observation }}" required>
                        </div>
            ...
            <div class="card-footer ">
                <div class="row">
                        <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Ok') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
