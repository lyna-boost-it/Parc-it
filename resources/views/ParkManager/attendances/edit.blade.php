    ...
    <div class="main-container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <form action="{{ route('ParkManager.attendances.updateAttendance', $attendance->id) }}" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="title">Le {{ $ldate }}: Marquer la Sortie pour: </h4>
                        </div>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="time" id="left_at_time" name="left_at_time"
                                                class="form-control" placeholder="Heure de sortie"
                            ...
                            <div class="card-footer ">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit"
                                            class="btn btn-info btn-round">{{ __('Ok') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
