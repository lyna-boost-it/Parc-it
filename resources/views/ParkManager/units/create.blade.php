	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.units.store',$unit->id)}}" method="post">
    ...
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="title">{{ __('Créer une unité ') }}</h3>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9" >
                <div class="form-group">
                    ...
                    value="{{ $unit->contact_name }}" required>
                </div>
                ...
                <div class="form-group">
                    <input type="text"
                     ...
                     placeholder="  Prénom du contact"
                      value="{{ $unit->contact_last_name }}" required>
                </div>
                        ...
                        <div class="form-group">
                            <input type="contact_function"
                             ...
                             placeholder=" Fonction du contact"
                              value="{{ $unit->contact_function }}" required>
                        </div>
                        @if ($errors->has('contact_function'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $errors->first('contact_function') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-md-9" >
                        <div class="form-group">
                            <input type="contact_phone"
                             ...
                             maxlength="10"
                             minlength="10"
                             placeholder=" N° du Téléphone"
                              value="{{ $unit->contact_phone }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="contact_mail"
                             ...
                             placeholder=" Adresse E-mail"
                              value="{{ $unit->contact_mail }}" required>
                        </div>
