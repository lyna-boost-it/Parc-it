							...
							<table class="table nowrap hover data-table-export">
								...
								<tbody>
                                    ...
                                    <tr>
                                        <td>{{$unit->id}}</td>
                                        <td> {{$unit->name}} </td>
                                        <td>{{$unit->contact_name}} {{$unit->contact_last_name}}</td>
                                        <td>{{$unit->contact_function}}</td>
                                        <td>{{$unit->contact_phone}}</td>
                                        <td>{{$unit->contact_mail}}</td>
                                                <td>
                                                    <div class="dropdown">
                                                        <a
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.units.edit',$unit->id)}}"
