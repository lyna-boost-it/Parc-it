        ...
        <div class="main-container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <form action="{{ route('ParkManager.repairs.storeRepairs', $repair->id) }}" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="title">{{ __(' N° de la Demande de Réparation (DR):') }} {{ $dt->code_dt }}
                                </h4>
                            </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" name="diagnostic" class="form-control"
                                                placeholder="Diagnostic" value="{{ $repair->diagnostic }}" required>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <label
                                        class="col-md-3 col-form-label">{{ __(' Personne(s) intervenante(s)') }}<span class="ob">*</span></label>
                                    <div class="col-md-9" for="conducteur_field_for_absence">
                                        <div class="form-group">
                                            <select name="staff[]" class="selectpicker"
                                                placeholder="  Nom et prénom de l\'absent" class="form-control"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" name="repaired_breakdowns" class="form-control"
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="date" name="end_date" class="form-control"
                                                placeholder="Date de sortie" value="{{ $repair->end_date }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="time" name="end_time" class="form-control"
                                                placeholder="Heure de sorti" value="{{ $repair->end_time }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" name="observation" class="form-control"
                                                placeholder="Observation" value="{{ $repair->observation }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-9" for="conducteur_field_for_absence">
                                        <div class="form-group">
                                            <select name="driver_id" placeholder="  Nom et prénom de l\'absent"
                                                value="{{ old('driver_id'), $repair->driver_id }}"class="form-control"
                                                id="staff_type">
                                                @foreach ($drivers as $driver)
                                                    <option value="{{ $driver->id }}"
                                                        {{ old('driver_id', $repair->driver_id) === 'driver_id' ? 'selected' : '' }}>
