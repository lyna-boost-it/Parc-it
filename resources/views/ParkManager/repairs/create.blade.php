                    ...
                    <div class="card-header">
                                    ...
                                    <div class="form-group">
                                        <input type="text"
                                         ...
                                         placeholder="Diagnostic"
                                          value="{{ $repair->diagnostic}}" required>
                                    </div>
                                ...
                                <div class="col-md-9" for="conducteur_field_for_absence">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('driver_id'),$repair->driver_id }}"class="form-control"
                                            ...
                                            {{ old('driver_id', $repair->driver_id)
                                             === 'driver_id' ? 'selected' : '' }}>
                        ...
                        <div class="card-body" >
                                    ...
                                    <table class="table" id="Pieces_table">
                                        ...
                                        <tbody>
                                            <tr id="product0">
                                                ...
                                                <td>
                                                    <input type="number" name="quantities[]" class="form-control"  placeholder="Max {{ $product->quantity }}"   />
                                                </td>
                                            </tr>
                                            <tr id="product1"></tr>
                                        </tbody>
                         ...
                         <div class="card-footer ">
                            <div class="row">
                             <div class="col-md-12 text-center">
                                    <button type="submit" class="btn   btn-round" style="background:#EE643A;color:#ffffff;"
                                    >{{ __('Ajouter') }}</button>
                                </div>
                            </div>
                        </div>
