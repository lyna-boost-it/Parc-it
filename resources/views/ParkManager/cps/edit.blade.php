...
<html>
	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.cps.updateCps',$cp->id)}}" method="post">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="title">{{ __('Modifier une pièce consommée') }}</h3>
        </div>
                    ...
                    <div class="form-group">
                        <input type="number"
                         ...
                         placeholder=" N° bon de sortie"
                          value="{{ $cp->receip}}" required>
                    </div>
                    @if ($errors->has('receip'))
                        <span class="invalid-feedback" style="display: block;" role="alert">
                            <strong>{{ $errors->first('receip') }}</strong>
                        </span>
                    @endif
                </div>
            </div>
