                                        ...
                                        <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="{{route('ParkManager.externals.editExternal',$external->id)}}"
                                                                ><i class="dw dw-edit2"></i> Modifier</a>
                                                       <a class="dropdown-item" href="{{route('ParkManager.externals.showExternal',$external->id)}}"
                                                                ><i class="dw dw-eye"></i> Consulter</a>

                                                            <form class="form-delete dropdown-item" method="post" action="{{route('ParkManager.externals.destroyExternal',$external->id)}}">
                                                                @method('DELETE')
                                                                @csrf
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div
                                                                        class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                          ...
                                                                          <a class="dropdown-item" href="{{route('ParkManager.externals.createExternal',$maintenance->id)}}"
