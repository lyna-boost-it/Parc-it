                    ...
                    <div id="test">
                        <div class="page-header">
                            <div class="row">
                                ...
                                <h3>Informations de maintenances externes: </h3>
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000">{{ $external->contract }} </h5>
                                        </th>


                                        <th>
                                            <h4 style="display: inline;color: #000000">Nom du fournisseur: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $guaranti->name_vendor }} </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color: #000000">Date d'entrée: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $external->start_date }} </h5>
                                        </th>
                                        <th>
                                            <h4 style="display: inline;color: #000000">Date de sortie: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $external->end_date }} </h5>
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000">{{ $external->panne_type }} </h5>

                                        <th>
                                            <h4 style="display: inline;color: #000000">Pièces rechangées: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $external->changed_piece }} </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <th>
                                            <h4 style="display: inline;color: #000000 "> Véhicule:<a
                                                    href="{{ route('ParkManager.vehicules.show', $vehicule->id) }}">
                                                    <span class="fa fa-eye  " style="color: #3d5fbb"></span> </a>
                                            </h4>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;color: #000000">{{ $vehicule->code }}</h5>
                                        </th>

                                        <th>
                                            <h4   style="display: inline;color: #000000">Date d'acquisition: </h4>
                                            <h5 style="display: inline;color: #000000">{{ $vehicule->acquisition_date }}</h5>
                                        </th>
                                    </tr>
                                </table>
                            </div>
