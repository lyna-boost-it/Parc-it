			...
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div id="test">
                    <div class="page-header">
                        <div class="row">
                                <div class="title">
                                    <h4>Information de maintenance externe pour {{ $dt->code_dt }}: </h4>
                                </div>
                           ...
                           <div class="col-md-6  ">
                               <div class="panel">
                                   <div class="panel-body bio-desk">
                                           <h4   style="display: inline;">Date d'entrée: </h4>
                                           <h5 style="display: inline;">{{  $external->start_date }} </h5>
                                           <br>
                                           <h4 style="display: inline;" >Date de sortie: </h4>
                                           <h5 style="display: inline;">{{  $external->end_date }} </h5>
                        ...
                        <div class="col-md-6  ">
                           <div class="panel">
                               <div class="panel-body bio-chart"  >
                                       ...
                                       <h5  style="display: inline;">{{  $external->panne_type}} </h5>
                                       <br>
                                       <h4 style="display: inline;" >Pièces rechangées: </h4>
                                       <h5 style="display: inline;">{{ $external->changed_piece }} </h5>
                               </div>
                           </div>
                       </div>
                       <div class="col-md-6  ">
                           <div class="panel">
                               <div class="panel-body bio-desk">
                                       ...
                                       <h5 style="display: inline;">{{  $external->price}} </h5>
