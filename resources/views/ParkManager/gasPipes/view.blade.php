                        ...
                        <div class="page-header" style="background-color:#aa4b2e">
                            ...
                            <div class="row">
                                ...
                                <table style=" width: 90%;border-collapse: collapse;">
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color:rgb(0, 0, 0)">Unité destinataire:</h4>
                                        ...
                                        <th>
                                            ...
                                            <h5 style="display: inline;;color:#000000">{{ $driver->name }} {{ $driver->last_name }}
                                            </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;color:#000000;"> N du ticket: </h4>
                                            <h5 style="display: inline;;color:#000000">{{ $gaspipe->ticket }}
                                            </h5>
                                        </th>
                                        <th>

                                            <h4 style="display: inline;;color:#000000 ">Agent remplisseur: </h4>
                                            <h5 style="display: inline;;color:#000000">{{ $staff->name }} {{ $staff->last_name }}
                                            </h5>
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <h5 style="display: inline;;color:#000000">{{ $gaspipe->price }}
                                            </h5>

                                        <th>
                                            <h4 style="display: inline;;color:#000000">Litre de Carburant (facultatif):</h4>
                                            <h5 style="display: inline;;color:#000000">{{ $gaspipe->litter }}
                                            </h5>
                                    </tr>
                                    <tr>
                                        <th>
                                            <h4 style="display: inline;;color:#000000">Prix du litre: </h4>
                                            <h5 style="display: inline;;color:#000000">{{ $gaspipe->litter_price }}
                                            </h5>
                                            <br>
                                        </th>
