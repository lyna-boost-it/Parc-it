                                ...
                                <div class="title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                        <h4 class="red">Unité destinataire:</h4>
                                                        <h3>{{ $unit->name }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                        <h4 class="terques">Nom et prénom du conducteur :</h4>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                    <h4 class="red"> N du ticket:</h4>
                                                    <h3> {{ $gaspipe->ticket }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                    <h4 class="terques">Agent remplisseur:</h4>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                    <h4 class="terques">Litre de Carburant (facultatif):</h4>
                                                    <h3>{{ $gaspipe->litter }}</h3>
                                                </div>
                                            </div>
                                        </div>
