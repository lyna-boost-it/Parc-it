	...
	<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                                <form action="{{route('ParkManager.gasPipes.store',$gaspipe->id)}}" method="post">
...
<br><br><br>
                        ...
                        <div class="card-header">
                            <h5 class="title">{{ __('Créer une consommation ') }}</h5>
                        </div>
                        ...
                        <div class="card-body" >
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('  Nom et prénom du conducteur') }}<span class="ob">*</span></label>
                                <div class="col-md-9" for="conducteur_field_for_absence">
                                    <div class="form-group">
                                        <select  name="driver_id"   placeholder="  Nom et prénom de l\'absent"
                                        value="{{ old('driver_id'),$gaspipe->driver_id }}"class="form-control"
                                            id="staff_type">
                                            @foreach ($drivers as $driver)

                                            <option value="{{ $driver->id }}"
                                            {{ old('driver_id', $gaspipe->driver_id)
                                             === 'driver_id' ? 'selected' : '' }}>
                        ...
                        <div class="card-body" >
                            <div class="row">
                                ...
                                <div class="col-md-9" for="conducteur_field_for_absence">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('staff_id'),$gaspipe->staff_id }}"class="form-control"
                                            id="staff_type">
                                            @foreach ($staffs as $staff)

                                            <option value="{{ $staff->id }}"
                                            {{ old('staff_id', $gaspipe->staff_id)
                                             === 'staff_id' ? 'selected' : '' }}>
                            ...
                            <div class="card-body" >
                                <div class="row">
                                    <label class="col-md-3 col-form-label">{{ __('  Unité destinataire') }}<span class="ob">*</span></label>
                                    <div class="col-md-9" for="Territoire">
                                        <div class="form-group">

                                            <select  name="unit_id"   placeholder="  Unité destinataire"
                                          class="form-control"
                                               >
