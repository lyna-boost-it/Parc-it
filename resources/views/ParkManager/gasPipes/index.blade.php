				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Gestion des  consommations de carburant pour équipements motorisés/ Pépinière</h4>
                     		</div>
					...
					<div class="card-box mb-30">
						...
						<div class="pb-20">
							...
							<table class="table nowrap hover data-table-export">
                                ...
                                @foreach($gaspipes as $gaspipe)
                                @foreach($drivers as $driver)
                                  @foreach($units as $unit)
                                  @foreach($staffs as $staff)

                                  @if ($gaspipe->driver_id==$driver->id && $gaspipe->unit_id==$unit->id
                                  && $gaspipe->staff_id==$staff->id)
                              <tr>
                                      <td>{{$gaspipe->id}}</td>
                                      ...
                                      <td>{{$gaspipe->price}}</td>
                                      <td>{{$unit->name}}</td>
                                      <td>{{$gaspipe->litter}}</td>
                                      <td>{{$gaspipe->litter_price}}</td>
