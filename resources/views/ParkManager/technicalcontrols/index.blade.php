					...
					<div class="card-box mb-30">
						...
						<div class="pb-20">
							...
							<table class="table nowrap hover  data-table-export">
                               ...
                               <th >Date d'effet et Date limite </th>
                               <th >Réserve</th>
                               <th  > Numéro du contrôle Technique</th>
								...
								<tbody>
                                    ...
                                    @if ($technicalcontrol->vehicle_id==$vehicule->id)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                   {{ Carbon\Carbon::parse($technicalcontrol->effective_date)->format('d-m-Y') }}<b>/</b>
                                                                                   {{  Carbon\Carbon::parse($technicalcontrol->expiration_date)->format('d-m-Y')}}
                                                                                    </td>
                                                                                <td>{{$technicalcontrol->reserve}}</td>
                                                                                <td>{{$technicalcontrol->technical_control_number}}</td>

                                                                                <td>{{$technicalcontrol->SirGaz}}</td>
                                                                            <td>{{$vehicule->acquisition_date}}</td>
                                              <td>{{$technicalcontrol->state}}</td>
