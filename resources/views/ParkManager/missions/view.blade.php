			...
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div id="test">
                    <div class="page-header">
                        <div class="row">
                                <div class="title">
                                    <h4  style="display: inline;">Information de Mission:</h4>

                                    @if($mission->mission_state=='fait')
                                    <h4  style="display: inline; color:green">Fait</h4>
                                @endif
                                @if($mission->mission_state=='en cours')
                                <h4  style="display: inline; color:rgb(201, 204, 45)"> En cours</h4>
                                @endif

                                @if($mission->mission_state=='en attente')
                                <h4  style="display: inline; color:rgb(204, 45, 183)"> En Attente</h4>
                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart" style="display: inline;">
                                                        <h4  style="display: inline;"> Numéro d’ordre  (Ordres de Mission): </h4>
                                                        <h5  style="display: inline;">{{ $mission->id }}</h5>
                                                        <br>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                    <h4  style="display: inline;" >Motif de la Mission: </h4>
                                                    <h5 style="display: inline;">{{ $mission->reason }}</h5>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-chart">
                                                    <h4 style="display: inline;" >Date de validité: </h4>
                                                    <h5 style="display: inline;"><b> Entre </b> {{ $mission->start_date }} <b> et entre </b> {{ $mission->end_date }}</h5>
                                                    <br>
                                                    <h4  style="display: inline;">Description: </h4>
                                                    <h5 style="display: inline;">{{ $mission->description }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="panel">
                                                <div class="panel-body bio-desk">
                                                    ...
                                                    <h5 style="display: inline;"> @if ($mission->territory=="")
