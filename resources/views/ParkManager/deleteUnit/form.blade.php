@if (Auth::user()->type == 'Gestionnaire parc' ||
    ...
    <body>
                ...
                <div class="page-header">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h3 style="color:#EE643A; ">Voulez-vous vraiment supprimer cette unité ?</h3>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-20">
                        <div class="card-box height-100-p pd-20">
                            ...
                            <form action="{{ route('ParkManager.deleteUnit.update', $unit->id) }}" method="post">
                                ...
                                <div class="card-box mb-30">
                                    <div class="pd-20">
                                        ...
                                        <h4 style="color:#000000;"> Choisir une unité de remplacement:</h4>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <select style="width: 300px" id="unit_id" name="unit_id">
                                                            <option></option>
                                                            @foreach ($units as $a)
                                                                <option value="{{ $a->id }}">
                                                                    {{ $a->name }} </option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button type="submit" class="btn   btn-round"
                                                    style="background:#EE643A;color:#ffffff;">{{ __('Transférer et Supprimer') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 mb-20">
                        <div class="card-box height-100-p pd-20">
                            <form action="{{ route('ParkManager.deleteUnit.edit', $unit->id) }}">

                            <h4 style="color:#000000;"> Laisser les personnels ,véhicules et machines appartenant à
                                cette unité sans unité</h4>
                            <br><br><br>
                            <br>
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn   btn-round"
                                        style="background:#EE643A;color:#ffffff;">{{ __('Supprimer') }}</button>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        <script type="text/javascript">
            $("#vehicle_id").select2({
                placeholder: "Sélectionner une unité de remplacement",
                allowClear: true
            });
        </script>
    </body>
